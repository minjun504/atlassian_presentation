...
*A clear, self-contained guide to the whole workshop, start to finish.*
...
This document is the written companion to the three workshop notebooks. Each part explains *what*
we're doing, *why* it matters, and *how* the code achieves it, with the key snippets inline. You can
read it straight through like a handbook, or keep it open beside the notebooks as you work.
